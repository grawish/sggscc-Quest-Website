...
<main class="page gallery-page">
        <section class="clean-block clean-gallery dark">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/President.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/President.webp"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/Vice.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/Vice.webp"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/GS.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/GS.webp"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/JS1.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/JS1.webp"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/JS2.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/JS2.webp"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/TRE.webp"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/TRE.webp"></a></div>
                </div>
